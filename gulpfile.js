...
gulp.task('copy:fonts', function () {
  return gulp.src([yeoman.app + '/fonts/**/*', 'bower_components/bootstrap/fonts/**/*'])
    .pipe(gulp.dest(yeoman.dist + '/fonts'));
});

gulp.task('build', ['clean:dist'], function () {
  gutil.log('Generating Dist Files');
  runSequence(['images', 'copy:extras', 'copy:fonts', 'client:build'], function(){gutil.log(gutil.colors.green('All files generated'))});
});
